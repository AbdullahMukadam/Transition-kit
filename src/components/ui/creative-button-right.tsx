...
function ButtonCreativeRight({ firstText, secondText }: CreateButtonProps) {
	return (
		<>
			<div className="group relative cursor-pointer p-2 w-full border bg-white rounded-full overflow-hidden text-black text-center font-semibold">
