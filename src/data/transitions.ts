...
document.startViewTransition(() => switchTheme());`,
		...
		video: "/demos/theme-toggles/circle-reveal.webm",
		featured: true,
	},
	{
		slug: "circle-blur",
...
document.startViewTransition(() => switchTheme());`,
		...
		video: "/demos/theme-toggles/circle-blur.webm",
		featured: true,
	},
	{
		slug: "polygon-reveal",
...
document.startViewTransition(() => switchTheme());`,
		...
		video: "/demos/theme-toggles/polygon-reveal.webm",
		featured: true,
	},
	{
		slug: "gif-frog",
...
@keyframes slide-in {
  ...
  document.startViewTransition(() => {
    window.location.href = url;
		...
		video: "/demos/page-transitions/slide.webm",
	},
	{
		slug: "scale",
		name: "Scale",
...
@keyframes scale-in {
  ...
  document.startViewTransition(() => {
    window.location.href = url;
		...
		video: "/demos/page-transitions/scale.webm",
		featured: true,
	},
	{
		slug: "flip",
...
@keyframes flip-in {
  ...
  document.startViewTransition(() => {
    window.location.href = url;
		...
		video: "/demos/page-transitions/flip.webm",
	},
	{
		slug: "blur",
		name: "Blur",
...
@keyframes blur-in {
  ...
  document.startViewTransition(() => {
    window.location.href = url;
		...
		video: "/demos/page-transitions/blur.webm",
	},
	{
		slug: "rotate",
		name: "Rotate",
